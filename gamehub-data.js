...
const HERO_SYNERGY_DATA = {
  // Assassins
  saber:      ['atlas','franco','chou','angela','khufra'],
  karina:     ['tigreal','franco','atlas','rafaela','angela'],
  fanny:      ['diggie','angela','lolita','rafaela','kaja'],
  hayabusa:   ['diggie','angela','chou','kaja','franco'],
  natalia:    ['diggie','angela','rafaela','lolita','atlas'],
  lancelot:   ['franco','chou','atlas','angela','minotaur'],
  helcurt:    ['angela','franco','atlas','kaja','rafaela'],
  gusion:     ['atlas','khufra','franco','angela','lolita'],
  selena:     ['franco','atlas','chou','angela','khufra'],
  hanzo:      ['angela','atlas','franco','khufra','rafaela'],
  ling:       ['diggie','mathilda','atlas','angela','khufra'],
  benedetta:  ['atlas','angela','khufra','franco','rafaela'],
  aamon:      ['franco','atlas','khufra','angela','lolita'],
  joy:        ['atlas','franco','khufra','angela','rafaela'],
  nolan:      ['angela','atlas','khufra','lolita','franco'],
  sora:       ['angela','atlas','khufra','rafaela','lolita'],
  // Fighters
  balmond:    ['rafaela','angela','atlas','franco','estes'],
  chou:       ['odette','vale','gusion','kagura','atlas'],
  ruby:       ['rafaela','angela','estes','atlas','floryn'],
  'lapu-lapu':['angela','rafaela','atlas','khufra','estes'],
  alucard:    ['angela','rafaela','estes','floryn','atlas'],
  freya:      ['rafaela','angela','atlas','khufra','lolita'],
  sun:        ['angela','rafaela','atlas','estes','lolita'],
  alpha:      ['rafaela','angela','atlas','estes','lolita'],
  gatotkaca:  ['rafaela','angela','gusion','atlas','estes'],
  jawhead:    ['atlas','franco','chou','gusion','khufra'],
  martis:     ['angela','atlas','rafaela','franco','estes'],
  aldous:     ['franco','atlas','angela','rafaela','khufra'],
  leomord:    ['angela','carmilla','atlas','rafaela','estes'],
  thamuz:     ['angela','atlas','rafaela','estes','floryn'],
  minsitthar: ['atlas','rafaela','angela','franco','estes'],
  badang:     ['aamon','gusion','kagura','vale','atlas'],
  terizla:    ['atlas','franco','angela','rafaela','estes'],
  'x-borg':   ['atlas','franco','angela','rafaela','estes'],
  dyrroth:    ['angela','atlas','rafaela','estes','franco'],
  silvanna:   ['odette','kagura','vale','gusion','atlas'],
  'yu-zhong': ['angela','rafaela','atlas','estes','floryn'],
  khaleed:    ['angela','atlas','rafaela','estes','franco'],
  paquito:    ['angela','atlas','khufra','rafaela','estes'],
  phoveus:    ['atlas','franco','angela','rafaela','estes'],
  yin:        ['franco','atlas','angela','rafaela','khufra'],
  julian:     ['angela','atlas','khufra','rafaela','franco'],
  fredrinn:   ['estes','angela','floryn','atlas','rafaela'],
  cici:       ['atlas','angela','rafaela','estes','franco'],
  arlott:     ['angela','atlas','khufra','rafaela','franco'],
  aulus:      ['rafaela','angela','lolita','atlas','estes'],
  masha:      ['angela','rafaela','atlas','estes','floryn'],
  suyou:      ['angela','atlas','khufra','rafaela','franco'],
  lukas:      ['angela','atlas','rafaela','estes','franco'],
  kalea:      ['angela','atlas','rafaela','estes','franco'],
  // Marksmen
  miya:       ['angela','lolita','atlas','rafaela','floryn'],
  popol:      ['lolita','atlas','angela','rafaela','estes'],
  bruno:      ['angela','lolita','atlas','khufra','rafaela'],
  clint:      ['angela','lolita','atlas','franco','rafaela'],
  layla:      ['angela','lolita','rafaela','atlas','floryn'],
  moskov:     ['franco','atlas','lolita','angela','rafaela'],
  karrie:     ['angela','diggie','lolita','atlas','rafaela'],
  iridhel:    ['angela','lolita','atlas','rafaela','estes'],
  hanabi:     ['lolita','atlas','angela','rafaela','floryn'],
  claude:     ['atlas','angela','lolita','khufra','diggie'],
  kimmy:      ['angela','atlas','khufra','rafaela','lolita'],
  granger:    ['franco','atlas','angela','lolita','rafaela'],
  wanwan:     ['tigreal','atlas','angela','lolita','diggie'],
  brody:      ['angela','franco','atlas','lolita','khufra'],
  beatrix:    ['angela','atlas','lolita','khufra','rafaela'],
  melissa:    ['angela','atlas','khufra','lolita','rafaela'],
  ixia:       ['angela','atlas','lolita','rafaela','floryn'],
  natan:      ['angela','atlas','lolita','rafaela','estes'],
  lesley:     ['angela','atlas','lolita','rafaela','floryn'],
  obsidia:    ['angela','atlas','lolita','rafaela','estes'],
  // Mages
  alice:      ['atlas','franco','angela','rafaela','estes'],
  eudora:     ['franco','atlas','tigreal','angela','chou'],
  gord:       ['tigreal','franco','atlas','chou','khufra'],
  kagura:     ['chou','franco','atlas','tigreal','khufra'],
  cyclops:    ['angela','rafaela','atlas','lolita','estes'],
  lunox:      ['atlas','khufra','franco','angela','chou'],
  odette:     ['tigreal','atlas','chou','kaja','franco'],
  zhask:      ['atlas','franco','tigreal','rafaela','lolita'],
  kadita:     ['franco','atlas','angela','khufra','chou'],
  lylia:      ['atlas','franco','angela','rafaela','estes'],
  harith:     ['atlas','angela','rafaela','estes','lolita'],
  yve:        ['atlas','khufra','franco','lolita','rafaela'],
  vale:       ['chou','atlas','franco','badang','khufra'],
  vexana:     ['franco','atlas','tigreal','rafaela','angela'],
  harley:     ['atlas','franco','chou','angela','khufra'],
  aurora:     ['franco','atlas','tigreal','chou','khufra'],
  pharsa:     ['atlas','franco','khufra','rafaela','lolita'],
  valir:      ['atlas','franco','lolita','khufra','chou'],
  xavier:     ['atlas','franco','lolita','angela','rafaela'],
  faramis:    ['atlas','franco','rafaela','estes','gusion'],
  novaria:    ['atlas','franco','angela','rafaela','lolita'],
  zetian:     ['atlas','franco','angela','rafaela','lolita'],
  zhuxin:     ['atlas','franco','angela','rafaela','khufra'],
  // Supports / Tanks
  tigreal:    ['odette','wanwan','kagura','lunox','gord'],
  akai:       ['gord','odette','lunox','yve','kagura'],
  franco:     ['gusion','aldous','odette','kagura','gord'],
  minotaur:   ['gusion','gord','kagura','lancelot','odette'],
  johnson:    ['gusion','saber','atlas','gord','franco'],
  hilda:      ['angela','rafaela','atlas','estes','gusion'],
  grock:      ['kagura','gusion','gord','odette','lunox'],
  argus:      ['angela','rafaela','atlas','estes','floryn'],
  hylos:      ['gusion','kagura','gord','odette','lancelot'],
  uranus:     ['angela','rafaela','gusion','atlas','odette'],
  belerick:   ['angela','rafaela','gusion','gord','mages'],
  khufra:     ['gusion','ling','lunox','odette','kagura'],
  baxia:      ['gusion','kagura','gord','odette','lunox'],
  atlas:      ['claude','gusion','odette','kagura','gord'],
  barats:     ['angela','rafaela','gusion','atlas','estes'],
  edith:      ['angela','rafaela','gusion','atlas','estes'],
  gloo:       ['gusion','kagura','gord','odette','lancelot'],
  angela:     ['fanny','ling','claude','karrie','wanwan'],
  nana:       ['angela','atlas','rafaela','franco','estes'],
  rafaela:    ['claude','karrie','wanwan','iridhel','hanabi'],
  lolita:     ['hanabi','iridhel','brody','claude','karrie'],
  estes:      ['alucard','fredrinn','ruby','masha','yu-zhong'],
  diggie:     ['fanny','ling','wanwan','karrie','claude'],
  carmilla:   ['estes','lolita','rafaela','atlas','leomord'],
  mathilda:   ['fanny','ling','benedetta','hayabusa','lancelot'],
  floryn:     ['fredrinn','alucard','ruby','masha','yu-zhong'],
  kaja:       ['odette','lunox','lolita','kagura','gord'],
  chip:       ['gusion','ling','fanny','lancelot','atlas'],
  marcel:     ['claude','karrie','wanwan','iridhel','hanabi'],
  esmeralda:  ['angela','rafaela','atlas','estes','floryn'],
  hirara:     ['angela','atlas','rafaela','estes','franco'],
};

const HERO_TIER_DATA = {
  masha:      { tier: 'S', wr: 58.3 }, marcel:     { tier: 'S', wr: 56.8 },
  gord:       { tier: 'S', wr: 55.7 }, minotaur:   { tier: 'S', wr: 55.4 },
  rafaela:    { tier: 'S', wr: 55.4 }, floryn:     { tier: 'S', wr: 54.9 },
  gloo:       { tier: 'S', wr: 54.7 }, iridhel:    { tier: 'S', wr: 53.9 },
  sun:        { tier: 'S', wr: 53.8 }, atlas:      { tier: 'S', wr: 53.7 },
  fredrinn:   { tier: 'S', wr: 53.0 }, estes:      { tier: 'S', wr: 52.9 },
  hanabi:     { tier: 'S', wr: 52.9 }, paquito:    { tier: 'S', wr: 52.8 },
  guinevere:  { tier: 'S', wr: 52.2 }, belerick:   { tier: 'S', wr: 52.1 },
  zetian:     { tier: 'S', wr: 51.5 }, minsitthar: { tier: 'S', wr: 51.2 },
  suyou:      { tier: 'S', wr: 50.8 }, saber:      { tier: 'S', wr: 49.5 },
  helcurt:    { tier: 'S', wr: 49.4 }, harley:     { tier: 'S', wr: 48.1 },
  khufra:     { tier: 'A', wr: 54.9 }, kaja:       { tier: 'A', wr: 54.8 },
  diggie:     { tier: 'A', wr: 54.4 }, ling:       { tier: 'A', wr: 54.1 },
  benedetta:  { tier: 'A', wr: 53.2 }, kadita:     { tier: 'A', wr: 52.5 },
  akai:       { tier: 'A', wr: 52.3 }, valir:      { tier: 'A', wr: 52.1 },
  hanzo:      { tier: 'A', wr: 51.9 }, hilda:      { tier: 'A', wr: 51.7 },
  leomord:    { tier: 'A', wr: 51.5 }, ruby:       { tier: 'A', wr: 51.3 },
  zhuxin:     { tier: 'A', wr: 50.7 }, miya:       { tier: 'A', wr: 50.3 },
  gusion:     { tier: 'A', wr: 49.8 }, sora:       { tier: 'A', wr: 49.6 },
  lolita:     { tier: 'B', wr: null }, yve:        { tier: 'B', wr: null },
  popol:      { tier: 'B', wr: null }, natalia:    { tier: 'B', wr: null },
  baxia:      { tier: 'B', wr: null }, lukas:      { tier: 'B', wr: null },
  khaleed:    { tier: 'B', wr: null }, kagura:     { tier: 'B', wr: null },
  carmilla:   { tier: 'B', wr: null }, terizla:    { tier: 'B', wr: null },
  cyclops:    { tier: 'B', wr: null }, brody:      { tier: 'B', wr: null },
  argus:      { tier: 'B', wr: null }, silvanna:   { tier: 'B', wr: null },
  beatrix:    { tier: 'B', wr: null }, badang:     { tier: 'B', wr: null },
  melissa:    { tier: 'B', wr: null }, aamon:      { tier: 'B', wr: null },
  moskov:     { tier: 'B', wr: null }, obsidia:    { tier: 'B', wr: null },
  clint:      { tier: 'B', wr: null }, alice:      { tier: 'B', wr: null },
  karrie:     { tier: 'B', wr: null }, claude:     { tier: 'B', wr: null },
  eudora:     { tier: 'B', wr: null }, selena:     { tier: 'B', wr: null },
  vexana:     { tier: 'B', wr: null }, angela:     { tier: 'B', wr: null },
  freya:      { tier: 'B', wr: null }, lesley:     { tier: 'B', wr: null },
  aulus:      { tier: 'C', wr: null }, faramis:    { tier: 'C', wr: null },
  bane:       { tier: 'C', wr: null }, bruno:      { tier: 'C', wr: null },
  natan:      { tier: 'C', wr: null }, edith:      { tier: 'C', wr: null },
  joy:        { tier: 'C', wr: null }, uranus:     { tier: 'C', wr: null },
  zhask:      { tier: 'C', wr: null }, odette:     { tier: 'C', wr: null },
  'x-borg':   { tier: 'C', wr: null }, lunox:      { tier: 'C', wr: null },
  phoveus:    { tier: 'C', wr: null }, balmond:    { tier: 'C', wr: null },
  'lapu-lapu':{ tier: 'C', wr: null }, julian:     { tier: 'C', wr: null },
  vale:       { tier: 'C', wr: null }, arlott:     { tier: 'C', wr: null },
  cecilision: { tier: 'C', wr: null }, aldous:     { tier: 'C', wr: null },
  ixia:       { tier: 'C', wr: null }, 'yu-zhong': { tier: 'C', wr: null },
  harith:     { tier: 'C', wr: null }, hylos:      { tier: 'C', wr: null },
  johnson:    { tier: 'C', wr: null }, lylia:      { tier: 'C', wr: null },
  cici:       { tier: 'C', wr: null }, xavier:     { tier: 'C', wr: null },
  hayabusa:   { tier: 'C', wr: null }, thamuz:     { tier: 'C', wr: null },
  kimmy:      { tier: 'C', wr: null }, 'chang-e':  { tier: 'C', wr: null },
  novaria:    { tier: 'C', wr: null }, yin:        { tier: 'C', wr: null },
  layla:      { tier: 'C', wr: null }, nana:       { tier: 'C', wr: null },
  barats:     { tier: 'D', wr: null }, chip:       { tier: 'D', wr: null },
  wanwan:     { tier: 'D', wr: null }, nolan:      { tier: 'D', wr: null },
  jawhead:    { tier: 'D', wr: null }, mathilda:   { tier: 'D', wr: null },
  aurora:     { tier: 'D', wr: null }, roger:      { tier: 'D', wr: null },
  alucard:    { tier: 'D', wr: null }, grock:      { tier: 'D', wr: null },
  'luo-yi':   { tier: 'D', wr: null }, pharsa:     { tier: 'D', wr: null },
  martis:     { tier: 'D', wr: null }, karina:     { tier: 'D', wr: null },
  gatotkaca:  { tier: 'D', wr: null }, zilong:     { tier: 'D', wr: null },
  dyrroth:    { tier: 'D', wr: null }, chou:       { tier: 'D', wr: null },
  alpha:      { tier: 'D', wr: null }, tigreal:    { tier: 'D', wr: null },
  valentina:  { tier: 'D', wr: null }, lancelot:   { tier: 'D', wr: null },
  fanny:      { tier: 'D', wr: null }, kalea:      { tier: 'D', wr: null },
  esmeralda:  { tier: 'D', wr: null }, granger:    { tier: 'D', wr: null },
  franco:     { tier: 'D', wr: null }, hirara:     { tier: 'D', wr: null },
};
...
const GameHubData = {
  heroes: MLBB_HERO_DATA_RAW.map(h => ({
    ...
    counters: h.counters || [],
    builds: h.builds || {},
    tier: (HERO_TIER_DATA[h.id] || {}).tier || null,
    wr: (HERO_TIER_DATA[h.id] || {}).wr || null,
    synergies: HERO_SYNERGY_DATA[h.id] || []
  })),
