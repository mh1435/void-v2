...
const MLBB_HERO_DATA_RAW = [
  ...
  { 
    ...
    builds: {
      ...
      'CD Reduction Pen': ['hunter_strike', 'queens_wings', 'war_axe', 'malefic_roar', 'rose_gold_meteor', 'immortality']
    }
  },
  { 
    id: 'karina', 
  ...
  { 
    ...
    builds: {
      ...
      'Sustain Offlane': ['queens_wings', 'hunter_strike', 'war_axe', 'brute_force_breastplate', 'athena_shield', 'immortality']
    }
  },
  { 
    id: 'hayabusa', 
    role: 'Assassin', 
    rarity: 'S+ TIER (GOD META)',
  ...
  { id: 'ling', role: 'Assassin', rarity: 'A-TIER', counters: ['khufra', 'saber', 'masha'], builds: { 'Crit Rate Burst': ['windtalker', 'berserker_fury', 'haas_claws', 'endless_battle', 'malefic_roar', 'immortality'] } },
  { id: 'benedetta', role: 'Assassin', rarity: 'A-TIER', counters: ['phoveus', 'khufra', 'masha'], builds: { 'EXP Lane Sustain': ['queens_wings', 'hunter_strike', 'war_axe', 'brute_force_breastplate', 'athena_shield', 'immortality'] } },
  { id: 'aamon', role: 'Assassin', rarity: 'S-TIER (META)', counters: ['athena_shield', 'radiant_armor'], builds: { 'Magic Execute': ['genius_wand', 'feather_of_heaven', 'holy_crystal', 'divine_glaive', 'winter_crown', 'blood_wings'] } },
  ...
  { id: 'nolan', role: 'Assassin', rarity: 'B-TIER', counters: ['khufra', 'saber', 'tigreal'], builds: { 'Maximum CD Pen': ['hunter_strike', 'blade_of_the_heptaseas', 'endless_battle', 'blade_of_despair', 'malefic_roar', 'immortality'] } },
  { id: 'sora', role: 'Fighter/Assassin', rarity: 'S+ TIER (GOD META)', counters: ['khufra', 'masha'], builds: { 'Jungle Meta Carry': ['hunter_strike', 'blade_of_despair', 'malefic_roar', 'immortality', 'rose_gold_meteor', 'war_axe'] } },
  ...
  { 
    ...
    builds: {
      ...
      'EXP Lane True DMG': ['war_axe', 'hunter_strike', 'queens_wings', 'brute_force_breastplate', 'oracle', 'immortality']
    }
  },
  { 
    id: 'chou', 
  ...
  { 
    ...
    counters: ['baxia', 'valir', 'dominance_ice'],
    builds: {
      'EXP Spellvamp Offlane': ['war_axe', 'queens_wings', 'dominance_ice', 'oracle', 'brute_force_breastplate', 'immortality'],
  ...
  { 
    ...
    counters: ['baxia', 'valir', 'dominance_ice'],
    builds: {
      'Sustain Offlane DMG': ['queens_wings', 'hunter_strike', 'war_axe', 'brute_force_breastplate', 'oracle', 'immortality'],
      'Full Tank Frontline': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'guardian_helmet', 'radiant_armor', 'immortality']
    }
  },
  { id: 'alucard', role: 'Fighter', rarity: 'C-TIER', counters: ['baxia', 'khufra'], builds: { 'Lifesteal Burst': ['haas_claws', 'hunter_strike', 'endless_battle', 'berserker_fury', 'malefic_roar', 'immortality'] } },
  { id: 'bane', role: 'Fighter/Mage', rarity: 'C-TIER', counters: ['saber', 'gusion'], builds: { 'Magic Cannon': ['enchanted_talisman', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'winter_crown', 'blood_wings'], 'Physical Burst': ['hunter_strike', 'blade_of_the_heptaseas', 'blade_of_despair', 'malefic_roar', 'endless_battle', 'immortality'] } },
  { id: 'zilong', role: 'Fighter/Assassin', rarity: 'C-TIER', counters: ['khufra', 'hylos'], builds: { 'Push Master': ['windtalker', 'berserker_fury', 'great_dragon_spear', 'demon_hunter_sword', 'malefic_roar', 'blade_of_despair'] } },
  { id: 'freya', role: 'Fighter', rarity: 'S-TIER (META)', counters: ['baxia', 'khufra'], builds: { 'Crit Attack Speed': ['corrosion_scythe', 'haas_claws', 'berserker_fury', 'great_dragon_spear', 'malefic_roar', 'immortality'] } },
  ...
  { id: 'alpha', role: 'Fighter', rarity: 'B-TIER', counters: ['baxia', 'valir'], builds: { 'True DMG Jungle': ['war_axe', 'queens_wings', 'hunter_strike', 'dominance_ice', 'oracle', 'immortality'] } },
  { id: 'roger', role: 'Fighter/Marksman', rarity: 'C-TIER', counters: ['saber', 'khufra'], builds: { 'Gold Lane Carry': ['windtalker', 'demon_hunter_sword', 'corrosion_scythe', 'brute_force_breastplate', 'rose_gold_meteor', 'immortality'] } },
  { id: 'gatotkaca', role: 'Tank/Fighter', rarity: 'A-TIER', counters: ['karrie', 'divine_glaive'], builds: { 'Magic Tank Vengeance': ['cursed_helmet', 'dominance_ice', 'athena_shield', 'holy_crystal', 'glowing_wand', 'immortality'] } },
  ...
  { id: 'martis', role: 'Fighter', rarity: 'C-TIER', counters: ['baxia', 'valir'], builds: { 'Semi-Tank Jungle': ['hunter_strike', 'war_axe', 'dominance_ice', 'antique_cuirass', 'athena_shield', 'immortality'] } },
  { id: 'aldous', role: 'Fighter', rarity: 'C-TIER', counters: ['chastise_pauldron', 'franco'], builds: { '500 Stack One-Punch': ['thunder_belt', 'chastise_pauldron', 'dominance_ice', 'athena_shield', 'antique_cuirass', 'immortality'] } },
  { id: 'leomord', role: 'Fighter', rarity: 'S-TIER (META)', counters: ['khufra', 'tigreal'], builds: { 'Crit Charge Core': ['hunter_strike', 'haas_claws', 'berserker_fury', 'malefic_roar', 'blade_of_despair', 'immortality'] } },
  ...
  { id: 'minsitthar', role: 'Fighter', rarity: 'B-TIER', counters: ['diggie', 'valir'], builds: { 'On-Hit King': ['corrosion_scythe', 'demon_hunter_sword', 'golden_staff', 'dominance_ice', 'athena_shield', 'immortality'] } },
  ...
  { id: 'guinevere', role: 'Fighter/Mage', rarity: 'A-TIER', counters: ['diggie', 'athena_shield'], builds: { 'Magic Knockup Burst': ['genius_wand', 'glowing_wand', 'holy_crystal', 'wishing_lantern', 'winter_crown', 'immortality'] } },
  { id: 'terizla', role: 'Fighter', rarity: 'B-TIER', counters: ['valir', 'karrie'], builds: { 'Pure EXP Lane Frontline': ['queens_wings', 'dominance_ice', 'antique_cuirass', 'athena_shield', 'guardian_helmet', 'immortality'] } },
  { id: 'x-borg', role: 'Fighter', rarity: 'B-TIER', counters: ['baxia', 'radiant_armor'], builds: { 'True DMG Spellvamp': ['immortality', 'war_axe', 'queens_wings', 'glowing_wand', 'ice_queen_wand', 'oracle'] } },
  { id: 'dyrroth', role: 'Fighter', rarity: 'A-TIER', counters: ['khufra', 'saber'], builds: { 'Armor Shredder Core': ['hunter_strike', 'blade_of_the_heptaseas', 'queens_wings', 'malefic_roar', 'antique_cuirass', 'immortality'] } },
  { id: 'silvanna', role: 'Fighter', rarity: 'C-TIER', counters: ['diggie', 'athena_shield'], builds: { 'Magic Lock Core': ['genius_wand', 'feather_of_heaven', 'holy_crystal', 'radiant_armor', 'athena_shield', 'immortality'] } },
  { id: 'yu-zhong', role: 'Fighter', rarity: 'S-TIER (META)', counters: ['baxia', 'dominance_ice'], builds: { 'Dragon Meta Sustain': ['hunter_strike', 'queens_wings', 'war_axe', 'dominance_ice', 'oracle', 'immortality'] } },
  { id: 'khaleed', role: 'Fighter', rarity: 'A-TIER', counters: ['saber', 'franco'], builds: { 'Early Game Aggro': ['blade_of_the_heptaseas', 'hunter_strike', 'queens_wings', 'athena_shield', 'antique_cuirass', 'immortality'] } },
  { id: 'paquito', role: 'Fighter', rarity: 'A-TIER', counters: ['khufra', 'saber'], builds: { 'Combo Burst Jungle': ['hunter_strike', 'blade_of_the_heptaseas', 'queens_wings', 'blade_of_despair', 'malefic_roar', 'immortality'] } },
  { id: 'phoveus', role: 'Fighter', rarity: 'S-TIER (META)', counters: ['athena_shield', 'esmeralda'], builds: { 'Anti-Dash Counter Magic': ['clock_of_destiny', 'lightning_truncheon', 'holy_crystal', 'oracle', 'brute_force_breastplate', 'immortality'] } },
  ...
  { id: 'julian', role: 'Fighter/Mage', rarity: 'S+ TIER (GOD META)', counters: ['athena_shield', 'radiant_armor'], builds: { 'Enhanced Skill Core Magic': ['genius_wand', 'feather_of_heaven', 'holy_crystal', 'divine_glaive', 'winter_crown', 'blood_wings'] } },
  { id: 'fredrinn', role: 'Tank/Fighter', rarity: 'S+ TIER (GOD META)', counters: ['karrie', 'divine_glaive'], builds: { 'Taunt Overlord Jungle': ['cursed_helmet', 'guardian_helmet', 'dominance_ice', 'radiant_armor', 'antique_cuirass', 'immortality'] } },
  ...
  { id: 'arlott', role: 'Fighter', rarity: 'S+ TIER (GOD META)', counters: ['phoveus', 'khufra'], builds: { 'Gaze Gank Master': ['hunter_strike', 'endless_battle', 'brute_force_breastplate', 'athena_shield', 'antique_cuirass', 'immortality'] } },
  { id: 'aulus', role: 'Fighter', rarity: 'C-TIER', counters: ['saber', 'hylos'], builds: { 'Late Game Hyper': ['windtalker', 'berserker_fury', 'haas_claws', 'great_dragon_spear', 'malefic_roar', 'immortality'] } },
  { id: 'masha', role: 'Fighter/Tank', rarity: 'B-TIER', counters: ['chastise_pauldron', 'blade_armor'], builds: { '3 HP Bar Shredder': ['windtalker', 'berserker_fury', 'blade_of_despair', 'malefic_roar', 'sea_halberd', 'great_dragon_spear'] } },
  ...
  { id: 'clint', role: 'Marksman', rarity: 'S-TIER (META)', counters: ['saber', 'wind_of_nature'], builds: { 'Passive Ability Burst': ['endless_battle', 'hunter_strike', 'berserker_fury', 'blade_of_despair', 'malefic_roar', 'rose_gold_meteor'] } },
  { id: 'layla', role: 'Marksman', rarity: 'C-TIER', counters: ['saber', 'ling', 'gusion'], builds: { 'Max Range Crit': ['windtalker', 'berserker_fury', 'haas_claws', 'great_dragon_spear', 'malefic_roar', 'blade_of_despair'] } },
  { id: 'moskov', role: 'Marksman', rarity: 'A-TIER', counters: ['saber', 'wind_of_nature'], builds: { 'Attack Speed Teleport': ['corrosion_scythe', 'demon_hunter_sword', 'golden_staff', 'haas_claws', 'malefic_roar', 'wind_of_nature'] } },
  { id: 'karrie', role: 'Marksman', rarity: 'S+ TIER (GOD META)', counters: ['saber', 'wind_of_nature'], builds: { 'Golden Trinity Meta': ['corrosion_scythe', 'demon_hunter_sword', 'golden_staff', 'thunder_belt', 'wind_of_nature', 'immortality'] } },
  { id: 'iridhel', role: 'Marksman', rarity: 'S-TIER (META)', counters: ['saber', 'wind_of_nature'], builds: { 'Run-and-Gun Crit': ['windtalker', 'berserker_fury', 'haas_claws', 'great_dragon_spear', 'malefic_roar', 'blade_of_despair'] } },
  ...
  { id: 'kimmy', role: 'Marksman/Mage', rarity: 'S+ TIER (GOD META)', counters: ['radiant_armor', 'lolita'], builds: { 'Magic Searing Aim': ['genius_wand', 'glowing_wand', 'holy_crystal', 'divine_glaive', 'ice_queen_wand', 'winter_crown'] } },
  { id: 'granger', role: 'Marksman', rarity: 'S+ TIER (GOD META)', counters: ['saber', 'khufra'], builds: { 'Jungle Bullet Burst': ['hunter_strike', 'blade_of_the_heptaseas', 'endless_battle', 'blade_of_despair', 'malefic_roar', 'immortality'] } },
  { id: 'wanwan', role: 'Marksman', rarity: 'S+ TIER (GOD META)', counters: ['phoveus', 'khufra'], builds: { 'Crossbow Weakness Melt': ['corrosion_scythe', 'demon_hunter_sword', 'windtalker', 'sea_halberd', 'malefic_roar', 'wind_of_nature'] } },
  { id: 'brody', role: 'Marksman', rarity: 'B-TIER', counters: ['saber', 'wind_of_nature'], builds: { 'Abyss Stack One-Shot': ['blade_of_the_heptaseas', 'hunter_strike', 'malefic_roar', 'blade_of_despair', 'brute_force_breastplate', 'immortality'] } },
  { id: 'beatrix', role: 'Marksman', rarity: 'S-TIER (META)', counters: ['saber', 'wind_of_nature'], builds: { 'Arsenal Heavy Carry': ['blade_of_the_heptaseas', 'hunter_strike', 'blade_of_despair', 'malefic_roar', 'rose_gold_meteor', 'immortality'] } },
  ...
  { id: 'natan', role: 'Marksman', rarity: 'A-TIER', counters: ['athena_shield', 'radiant_armor'], builds: { 'Magic Atk Spd Marksman': ['feather_of_heaven', 'genius_wand', 'holy_crystal', 'divine_glaive', 'glowing_wand', 'wind_of_nature'] } },
  { id: 'lesley', role: 'Marksman/Assassin', rarity: 'A-TIER', counters: ['saber', 'chastise_pauldron'], builds: { 'Sniper True Damage': ['windtalker', 'berserker_fury', 'endless_battle', 'blade_of_despair', 'malefic_roar', 'rose_gold_meteor'] } },
  { id: 'obsidia', role: 'Marksman', rarity: 'B-TIER', counters: ['saber', 'wind_of_nature'], builds: { 'Gold Core Build': ['corrosion_scythe', 'demon_hunter_sword', 'golden_staff', 'malefic_roar', 'wind_of_nature', 'immortality'] } },
  ...
  { id: 'eudora', role: 'Mage', rarity: 'C-TIER', counters: ['athena_shield'], builds: { 'Insta-Kill Bush Combo': ['genius_wand', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'blood_wings', 'winter_crown'] } },
  { id: 'gord', role: 'Mage', rarity: 'C-TIER', counters: ['saber', 'ling'], builds: { 'True DMG Beam Melt': ['enchanted_talisman', 'glowing_wand', 'ice_queen_wand', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  { id: 'kagura', role: 'Mage', rarity: 'B-TIER', counters: ['athena_shield'], builds: { 'Umbrella Burst Combo': ['clock_of_destiny', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'blood_wings', 'winter_crown'] } },
  ...
  { id: 'aurora', role: 'Mage', rarity: 'B-TIER', counters: ['athena_shield'], builds: { 'AOE Freeze Control': ['enchanted_talisman', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'winter_crown', 'blood_wings'] } },
  { id: 'vexana', role: 'Mage', rarity: 'B-TIER', counters: ['saber', 'ling'], builds: { 'Lord Summon Setup': ['enchanted_talisman', 'lightning_truncheon', 'holy_crystal', 'glowing_wand', 'divine_glaive', 'winter_crown'] } },
  { id: 'harley', role: 'Mage/Assassin', rarity: 'S-TIER (META)', counters: ['athena_shield', 'radiant_armor'], builds: { 'Jungle Ring Burst': ['genius_wand', 'feather_of_heaven', 'holy_crystal', 'divine_glaive', 'glowing_wand', 'winter_crown'] } },
  { id: 'odette', role: 'Mage', rarity: 'B-TIER', counters: ['tigreal', 'franco', 'athena_shield'], builds: { 'Swan Song CC Combo': ['enchanted_talisman', 'glowing_wand', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  { id: 'zhask', role: 'Mage', rarity: 'C-TIER', counters: ['radiant_armor'], builds: { 'Spawn Attack Speed': ['clock_of_destiny', 'feather_of_heaven', 'genius_wand', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  { id: 'pharsa', role: 'Mage', rarity: 'S+ TIER (GOD META)', counters: ['saber', 'ling'], builds: { 'Air Strike Burst': ['clock_of_destiny', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'blood_wings', 'winter_crown'] } },
  { id: 'valir', role: 'Mage', rarity: 'A-TIER', counters: ['radiant_armor', 'assassins'], builds: { 'Anti-Melee Slow Burn': ['enchanted_talisman', 'glowing_wand', 'ice_queen_wand', 'radiant_armor', 'athena_shield', 'immortality'] } },
  ...
  { id: 'lunox', role: 'Mage', rarity: 'B-TIER', counters: ['radiant_armor'], builds: { 'Order/Chaos Tank Melter': ['enchanted_talisman', 'genius_wand', 'glowing_wand', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  { id: 'harith', role: 'Mage', rarity: 'S-TIER (META)', counters: ['khufra', 'masha'], builds: { 'Gold Lane Magic Carry': ['clock_of_destiny', 'starlium_scythe', 'holy_crystal', 'feather_of_heaven', 'oracle', 'winter_crown'] } },
  ...
  { id: 'esmeralda', role: 'Mage/Tank', rarity: 'B-TIER', counters: ['baxia', 'dominance_ice'], builds: { 'Shield Absorption Frontline': ['enchanted_talisman', 'dominance_ice', 'oracle', 'brute_force_breastplate', 'glowing_wand', 'immortality'] } },
  ...
  { id: 'yve', role: 'Mage', rarity: 'S+ TIER (GOD META)', counters: ['saber', 'ling'], builds: { 'Grid Matrix Slow': ['enchanted_talisman', 'glowing_wand', 'ice_queen_wand', 'genius_wand', 'brute_force_breastplate', 'winter_crown'] } },
  ...
  { id: 'xavier', role: 'Mage', rarity: 'B-TIER', counters: ['saber', 'ling'], builds: { 'Global Laser Cannon': ['enchanted_talisman', 'clock_of_destiny', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  { id: 'novaria', role: 'Mage', rarity: 'B-TIER', counters: ['radiant_armor'], builds: { 'Sniper Vision Support': ['enchanted_talisman', 'glowing_wand', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  { id: 'zhuxin', role: 'Mage', rarity: 'S+ TIER (GOD META)', counters: ['radiant_armor'], builds: { 'Meta Crowd Control': ['enchanted_talisman', 'glowing_wand', 'ice_queen_wand', 'athena_shield', 'dominance_ice', 'winter_crown'] } },
  { id: 'luo-yi', role: 'Mage', rarity: 'S-TIER (META)', counters: ['radiant_armor'], builds: { 'Yin-Yang Teleport Burst': ['enchanted_talisman', 'glowing_wand', 'genius_wand', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  { id: 'zetian', role: 'Mage', rarity: 'S-TIER (META)', counters: ['athena_shield'], builds: { 'Mid Burn Burst': ['clock_of_destiny', 'lightning_truncheon', 'glowing_wand', 'holy_crystal', 'divine_glaive', 'winter_crown'] } },
  ...
  { id: 'akai', role: 'Tank', rarity: 'C-TIER', counters: ['valir', 'diggie'], builds: { 'Jungle Pin Tank': ['cursed_helmet', 'guardian_helmet', 'dominance_ice', 'radiant_armor', 'immortality', 'antique_cuirass'] } },
  { id: 'franco', role: 'Tank', rarity: 'B-TIER', counters: ['diggie'], builds: { 'Suppression Setup': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'immortality', 'radiant_armor', 'guardian_helmet'] } },
  { id: 'minotaur', role: 'Tank/Support', rarity: 'S+ TIER (GOD META)', counters: ['diggie'], builds: { 'Heal-CC Setup Roam': ['dominance_ice', 'athena_shield', 'oracle', 'antique_cuirass', 'immortality', 'guardian_helmet'] } },
  ...
  { id: 'hilda', role: 'Fighter/Tank', rarity: 'A-TIER', counters: ['karrie'], builds: { 'Bush Invader': ['blade_of_the_heptaseas', 'hunter_strike', 'dominance_ice', 'antique_cuirass', 'athena_shield', 'immortality'] } },
  { id: 'grock', role: 'Tank', rarity: 'S-TIER (META)', counters: ['valir'], builds: { 'Physical Atk Tank': ['blade_of_the_heptaseas', 'hunter_strike', 'blade_of_despair', 'antique_cuirass', 'athena_shield', 'immortality'] } },
  { id: 'argus', role: 'Fighter/Tank', rarity: 'C-TIER', counters: ['franco', 'kaja'], builds: { 'Fallen Angel Crit': ['windtalker', 'berserker_fury', 'haas_claws', 'demon_hunter_sword', 'malefic_roar', 'sea_halberd'] } },
  { id: 'hylos', role: 'Tank', rarity: 'A-TIER', counters: ['karrie', 'divine_glaive'], builds: { 'Max HP Clock Frontline': ['clock_of_destiny', 'dominance_ice', 'glowing_wand', 'radiant_armor', 'antique_cuirass', 'immortality'] } },
  { id: 'uranus', role: 'Tank', rarity: 'S+ TIER (GOD META)', counters: ['baxia', 'dominance_ice'], builds: { 'Regen Core Frontline': ['enchanted_talisman', 'oracle', 'brute_force_breastplate', 'radiant_armor', 'guardian_helmet', 'immortality'] } },
  { id: 'belerick', role: 'Tank', rarity: 'A-TIER', counters: ['griving_wand'], builds: { 'Marksman Taunt Anti-Crit': ['blade_armor', 'dominance_ice', 'cursed_helmet', 'oracle', 'chastise_pauldron', 'immortality'] } },
  { id: 'khufra', role: 'Tank', rarity: 'C-TIER', counters: ['diggie', 'valir'], builds: { 'Anti-Dash Bounce Setup': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'radiant_armor', 'chastise_pauldron', 'immortality'] } },
  ...
  { id: 'atlas', role: 'Tank', rarity: 'B-TIER', counters: ['diggie', 'valir'], builds: { 'Kraken Flip CC Setup': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'immortality', 'fleeting_time', 'guardian_helmet'] } },
  ...
  { id: 'edith', role: 'Tank/Marksman', rarity: 'A-TIER', counters: ['saber', 'masha'], builds: { 'Defense to Attack Convert': ['dominance_ice', 'athena_shield', 'blade_armor', 'holy_crystal', 'feather_of_heaven', 'immortality'] } },
  { id: 'gloo', role: 'Tank', rarity: 'S+ TIER (GOD META)', counters: ['baxia'], builds: { 'Split Attachment Frontline': ['cursed_helmet', 'glowing_wand', 'dominance_ice', 'oracle', 'athena_shield', 'immortality'] } },
  ...
  { id: 'nana', role: 'Mage/Support', rarity: 'C-TIER', counters: ['athena_shield'], builds: { 'Molina Burst Trap': ['enchanted_talisman', 'lightning_truncheon', 'holy_crystal', 'divine_glaive', 'blood_wings', 'winter_crown'] } },
  ...
  { id: 'lolita', role: 'Support/Tank', rarity: 'B-TIER', counters: ['diggie'], builds: { 'Shield Guard Setup': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'guardian_helmet', 'chastise_pauldron', 'immortality'] } },
  { id: 'estes', role: 'Support', rarity: 'A-TIER', counters: ['baxia', 'dominance_ice'], builds: { 'Font of Life Heal': ['enchanted_talisman', 'oracle', 'dominance_ice', 'immortality', 'athena_shield', 'guardian_helmet'] } },
  { id: 'diggie', role: 'Support', rarity: 'S+ TIER (GOD META)', counters: ['natalia', 'saber'], builds: { 'Anti-CC Meta Utility': ['enchanted_talisman', 'fleeting_time', 'dominance_ice', 'athena_shield', 'antique_cuirass', 'immortality'] } },
  { id: 'carmilla', role: 'Support/Tank', rarity: 'B-TIER', counters: ['baxia'], builds: { 'Link CC Frontline': ['cursed_helmet', 'dominance_ice', 'athena_shield', 'guardian_helmet', 'oracle', 'immortality'] } },
  ...
  { id: 'floryn', role: 'Support', rarity: 'S+ TIER (GOD META)', counters: ['baxia', 'dominance_ice'], builds: { 'Global Map Heal': ['enchanted_talisman', 'fleeting_time', 'oracle', 'athena_shield', 'dominance_ice', 'immortality'] } },
  { id: 'faramis', role: 'Mage/Support', rarity: 'B-TIER', counters: ['valentina'], builds: { 'Cult Altar Resurrection': ['enchanted_talisman', 'glowing_wand', 'genius_wand', 'lightning_truncheon', 'divine_glaive', 'winter_crown'] } },
  { id: 'kaja', role: 'Support/Fighter', rarity: 'C-TIER', counters: ['diggie'], builds: { 'Suppression Flicker Roam': ['fleeting_time', 'dominance_ice', 'athena_shield', 'antique_cuirass', 'guardian_helmet', 'immortality'] } },
  { id: 'chip', role: 'Support/Tank', rarity: 'A-TIER', counters: ['diggie'], builds: { 'Portal Gatherer Tank': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'guardian_helmet', 'radiant_armor', 'immortality'] } },
...
const MLBB_ITEM_DATA_RAW = [
  // Physical Attack Items (current as of Patch 2.1.88)
  ...
  { id: 'malefic_gun',            name: 'Malefic Gun',            type: 'Physical',  tier: 'TIER III' },
  ...
  { id: 'sky_piercer',            name: 'Sky Piercer',            type: 'Physical',  tier: 'TIER III' },
  // Magic Items (current as of Patch 2.1.88)
  ...
  { id: 'starlium_scythe',        name: 'Starlium Scythe',        type: 'Magic',     tier: 'TIER III' },
  { id: 'wishing_lantern',        name: 'Wishing Lantern',        type: 'Magic',     tier: 'TIER III' },
  { id: 'flask_of_the_oasis',     name: 'Flask of the Oasis',     type: 'Magic',     tier: 'TIER III' },
  // Defense Items (current as of Patch 2.1.88)
  { id: 'radiant_armor',          name: 'Radiant Armor',          type: 'Defense',   tier: 'TIER III' },
  { id: 'chastise_pauldron',      name: 'Chastise Pauldron',      type: 'Defense',   tier: 'TIER III' },
  ...
  { id: 'queens_wings',           name: "Queen's Wings",          type: 'Defense',   tier: 'TIER III' },
  // Movement / Boots
  { id: 'warrior_boots',          name: 'Warrior Boots',          type: 'Movement',  tier: 'TIER III' },
  { id: 'tough_boots',            name: 'Tough Boots',            type: 'Movement',  tier: 'TIER III' },
  { id: 'magic_shoes',            name: 'Magic Shoes',            type: 'Movement',  tier: 'TIER III' },
  { id: 'arcane_boots',           name: 'Arcane Boots',           type: 'Movement',  tier: 'TIER III' },
  { id: 'rapid_boots',            name: 'Rapid Boots',            type: 'Movement',  tier: 'TIER III' },
  { id: 'swift_boots',            name: 'Swift Boots',            type: 'Movement',  tier: 'TIER III' },
];

/* Local item images — all 320×320 PNGs from images/items/.
   Falls back to Fandom CDN with referrerpolicy="no-referrer" for anything not listed here. */
const ITEM_LOCAL_IMGS = {
  sea_halberd:              'images/items/sea-healberd-png.png',
  rose_gold_meteor:         'images/items/rose-gold-meteor-png.png',
  hunter_strike:            'images/items/hunter-strike-png.png',
  blade_of_despair:         'images/items/blade-of-despair-png.png',
  blade_of_the_heptaseas:   'images/items/blade-of-heptaseas-png.png',
  windtalker:               'images/items/windtalker-png.png',
  endless_battle:           'images/items/endless-battle-png.png',
  berserker_fury:           'images/items/bersekers-fury-png.png',
  haas_claws:               'images/items/haas-claw-png.png',
  malefic_roar:             'images/items/malefic-roar-png.png',
  malefic_gun:              'images/items/malefic-gun-png.png',
  war_axe:                  'images/items/war-axe-png.png',
  wind_of_nature:           'images/items/wind-of-nature-png.png',
  corrosion_scythe:         'images/items/corrosion-scythe.png',
  demon_hunter_sword:       'images/items/demon-hunter-sword-png.png',
  great_dragon_spear:       'images/items/great-dragon-spear-png.png',
  golden_staff:             'images/items/golden-staff-png.png',
  sky_piercer:              'images/items/sky-piercer-png.png',
  genius_wand:              'images/items/genius-wand-png.png',
  lightning_truncheon:      'images/items/lightning-truncheon-png.png',
  fleeting_time:            'images/items/fleeting-time-png.png',
  blood_wings:              'images/items/blood-wings-png.png',
  clock_of_destiny:         'images/items/clock-of-destiny-png.png',
  holy_crystal:             'images/items/holy-crystal-png.png',
  divine_glaive:            'images/items/divine-glaive-png.png',
  glowing_wand:             'images/items/glowing-wand-png.png',
  ice_queen_wand:           'images/items/ice-queen-wand-png.png',
  feather_of_heaven:        'images/items/feather-of-heaven-png.png',
  enchanted_talisman:       'images/items/enhanched-talisman-png.png',
  winter_crown:             'images/items/winter-crown-png.png',
  concentrated_energy:      'images/items/concentrated-energy-png.png',
  starlium_scythe:          'images/items/starlium-scythe-png.png',
  wishing_lantern:          'images/items/wishing-lantern-png.png',
  flask_of_the_oasis:       'images/items/flask-of-the-oasis-png.png',
  radiant_armor:            'images/items/radiant-armor-png.png',
  chastise_pauldron:        'images/items/chastise-pauldron-png.png',
  brute_force_breastplate:  'images/items/brute-force-breastplate-png.png',
  immortality:              'images/items/immortality-png.png',
  dominance_ice:            'images/items/dominance-ace-png.png',
  athena_shield:            'images/items/athena-shield-png.png',
  oracle:                   'images/items/oracle-png.png',
  antique_cuirass:          'images/items/antique-cuirass-png.png',
  guardian_helmet:          'images/items/guardian-helmet-png.png',
  blade_armor:              'images/items/blade-armor-png.png',
  thunder_belt:             'images/items/thunder-belt-png.png',
  cursed_helmet:            'images/items/cursed-helmet-png.png',
  queens_wings:             'images/items/queens-wings-png.png',
  warrior_boots:            'images/items/warrior-boots-png-min.png',
  tough_boots:              'images/items/tough-boots-png-min.png',
  magic_shoes:              'images/items/magic-shoes-png-min.png',
  arcane_boots:             'images/items/arcane-boots-png-min.png',
  rapid_boots:              'images/items/rapid-boots-png-min.png',
  swift_boots:              'images/items/swift-boots-png-min.png',
};
...
const ITEM_WIKI_OVERRIDES = {
  ...
  chastise_pauldron:        "Chastise_Pauldron",
...
function resolveItemImg(id) {
  if (ITEM_LOCAL_IMGS[id]) return ITEM_LOCAL_IMGS[id];
