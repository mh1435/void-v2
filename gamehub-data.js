...
const MLBB_HERO_DATA_RAW = [
  ...
  { id: 'alpha', role: 'Fighter', rarity: 'A-TIER', counters: ['baxia', 'valir'], builds: { 'True DMG Jungle': ['war_axe', 'queens_wings', 'hunter_strike', 'dominance_ice', 'oracle', 'immortality'] } },
  ...
  { id: 'aldous', role: 'Fighter', rarity: 'B-TIER', counters: ['chastise_pauldron', 'franco'], builds: { '500 Stack One-Punch': ['thunder_belt', 'chastise_pauldron', 'dominance_ice', 'athena_shield', 'antique_cuirass', 'immortality'] } },
  { id: 'leomord', role: 'Fighter', rarity: 'B-TIER', counters: ['khufra', 'tigreal'], builds: { 'Crit Charge Core': ['hunter_strike', 'haas_claws', 'berserker_fury', 'malefic_roar', 'blade_of_despair', 'immortality'] } },
  ...
  { id: 'terizla', role: 'Fighter', rarity: 'S-TIER (META)', counters: ['valir', 'karrie'], builds: { 'Pure EXP Lane Frontline': ['queens_wings', 'dominance_ice', 'antique_cuirass', 'athena_shield', 'guardian_helmet', 'immortality'] } },
  { id: 'x-borg', role: 'Fighter', rarity: 'A-TIER', counters: ['baxia', 'radiant_armor'], builds: { 'True DMG Spellvamp': ['immortality', 'war_axe', 'queens_wings', 'glowing_wand', 'ice_queen_wand', 'oracle'] } },
  ...
  { id: 'khaleed', role: 'Fighter', rarity: 'B-TIER', counters: ['saber', 'franco'], builds: { 'Early Game Aggro': ['blade_of_the_heptaseas', 'hunter_strike', 'queens_wings', 'athena_shield', 'antique_cuirass', 'immortality'] } },
  { id: 'paquito', role: 'Fighter', rarity: 'S-TIER (META)', counters: ['khufra', 'saber'], builds: { 'Combo Burst Jungle': ['hunter_strike', 'blade_of_the_heptaseas', 'queens_wings', 'blade_of_despair', 'malefic_roar', 'immortality'] } },
  ...
  { id: 'masha', role: 'Fighter/Tank', rarity: 'A-TIER', counters: ['chastise_pauldron', 'blade_armor'], builds: { '3 HP Bar Shredder': ['windtalker', 'berserker_fury', 'blade_of_despair', 'malefic_roar', 'sea_halberd', 'great_dragon_spear'] } },
  ...
  { id: 'lesley', role: 'Marksman/Assassin', rarity: 'B-TIER', counters: ['saber', 'chastise_pauldron'], builds: { 'Sniper True Damage': ['windtalker', 'berserker_fury', 'endless_battle', 'blade_of_despair', 'malefic_roar', 'rose_gold_meteor'] } },
  ...
  { id: 'franco', role: 'Tank', rarity: 'A-TIER', counters: ['diggie'], builds: { 'Suppression Setup': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'immortality', 'radiant_armor', 'guardian_helmet'] } },
  ...
  { id: 'belerick', role: 'Tank', rarity: 'B-TIER', counters: ['griving_wand'], builds: { 'Marksman Taunt Anti-Crit': ['blade_armor', 'dominance_ice', 'cursed_helmet', 'oracle', 'chastise_pauldron', 'immortality'] } },
  { id: 'khufra', role: 'Tank', rarity: 'A-TIER', counters: ['diggie', 'valir'], builds: { 'Anti-Dash Bounce Setup': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'radiant_armor', 'chastise_pauldron', 'immortality'] } },
  ...
  { id: 'lolita', role: 'Support/Tank', rarity: 'A-TIER', counters: ['diggie'], builds: { 'Shield Guard Setup': ['dominance_ice', 'athena_shield', 'antique_cuirass', 'guardian_helmet', 'chastise_pauldron', 'immortality'] } },
