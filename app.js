...
const STUDY_LOCATIONS = [
  ...
  { id:'osaka',         name:'OSAKA',          region:'EAST ASIA',  flag:'🏯', yt:'kG8VECrip1o' },
  { id:'taipei',        name:'TAIPEI',         region:'EAST ASIA',  flag:'🇹🇼', yt:'1sN8mOiX-4E' },
  { id:'bangkok',       name:'BANGKOK',        region:'SE ASIA',    flag:'🇹🇭', yt:'I0dwuTwaegc' },
  ...
  { id:'los-angeles',   name:'LOS ANGELES',    region:'AMERICAS',   flag:'🌴', yt:'3ecyAHQDsIU' },
  ...
  { id:'sydney',        name:'SYDNEY',         region:'OCEANIA',    flag:'🇦🇺', yt:'drDJNHDEvjk' },
