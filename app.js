...
const STUDY_LOCATIONS = [
  ...
  { id:'tokyo',         name:'TOKYO',          region:'EAST ASIA',  flag:'🗼', yt:'F5Rbs4GBdGo' },
  { id:'kyoto',         name:'KYOTO',          region:'EAST ASIA',  flag:'⛩️', yt:'qExFVKDDzxw' },
  { id:'osaka',         name:'OSAKA',          region:'EAST ASIA',  flag:'🏯', yt:'C7DSQzEVbHk' },
  { id:'seoul',         name:'SEOUL',          region:'EAST ASIA',  flag:'🇰🇷', yt:'yBNqUMYcnMQ' },
  { id:'hong-kong',     name:'HONG KONG',      region:'EAST ASIA',  flag:'🇭🇰', yt:'5qap5aO4i9A' },
  { id:'taipei',        name:'TAIPEI',         region:'EAST ASIA',  flag:'🇹🇼', yt:'9Auq9mYxFEE' },
  { id:'shanghai',      name:'SHANGHAI',       region:'EAST ASIA',  flag:'🇨🇳', yt:'ZRLMKczGnhU' },
  { id:'beijing',       name:'BEIJING',        region:'EAST ASIA',  flag:'🇨🇳', yt:'b87bWX6oEb8' },
  { id:'singapore',     name:'SINGAPORE',      region:'SE ASIA',    flag:'🇸🇬', yt:'wYHcO4uVy2E' },
  { id:'kuala-lumpur',  name:'KUALA LUMPUR',   region:'SE ASIA',    flag:'🇲🇾', yt:'BNBsY5lH0B4' },
  { id:'bangkok',       name:'BANGKOK',        region:'SE ASIA',    flag:'🇹🇭', yt:'dG-bGfK5b5w' },
  ...
  { id:'dubai',         name:'DUBAI',          region:'MIDDLE EAST',flag:'🌇', yt:'tG_8EmRbFHI' },
  { id:'istanbul',      name:'ISTANBUL',       region:'MIDDLE EAST',flag:'🇹🇷', yt:'npTBK0VmhxI' },
  { id:'new-york',      name:'NEW YORK',       region:'AMERICAS',   flag:'🗽', yt:'3eVMPDmqEAY' },
  { id:'los-angeles',   name:'LOS ANGELES',    region:'AMERICAS',   flag:'🌴', yt:'xTj8MpEFyuI' },
  ...
  { id:'london',        name:'LONDON',         region:'EUROPE',     flag:'🇬🇧', yt:'2W-IOPNIpko' },
  ...
  { id:'sydney',        name:'SYDNEY',         region:'OCEANIA',    flag:'🇦🇺', yt:'1Y2musA-bRQ' },
