...
const STUDY_LOCATIONS = [
  ...
  { id:'tokyo',         name:'TOKYO',          region:'EAST ASIA',  flag:'🗼', yt:'qTAlOTWtfU4' },
  { id:'kyoto',         name:'KYOTO',          region:'EAST ASIA',  flag:'⛩️', yt:'PDRvU2QbVFg' },
  { id:'osaka',         name:'OSAKA',          region:'EAST ASIA',  flag:'🏯', yt:'LWutclLmC0U' },
  { id:'seoul',         name:'SEOUL',          region:'EAST ASIA',  flag:'🇰🇷', yt:'KvpheVCkxgA' },
  { id:'hong-kong',     name:'HONG KONG',      region:'EAST ASIA',  flag:'🇭🇰', yt:'5qap5aO4i9A' },
  { id:'taipei',        name:'TAIPEI',         region:'EAST ASIA',  flag:'🇹🇼', yt:'VXD4hH4gGYg' },
  { id:'shanghai',      name:'SHANGHAI',       region:'EAST ASIA',  flag:'🇨🇳', yt:'IfzgriDeQP0' },
  { id:'beijing',       name:'BEIJING',        region:'EAST ASIA',  flag:'🇨🇳', yt:'uk9BV4eA_ng' },
  { id:'singapore',     name:'SINGAPORE',      region:'SE ASIA',    flag:'🇸🇬', yt:'wYHcO4uVy2E' },
  { id:'kuala-lumpur',  name:'KUALA LUMPUR',   region:'SE ASIA',    flag:'🇲🇾', yt:'ipv-a5zfuLM' },
  { id:'bangkok',       name:'BANGKOK',        region:'SE ASIA',    flag:'🇹🇭', yt:'EYrYbiiiaYo' },
  { id:'hanoi',         name:'HANOI',          region:'SE ASIA',    flag:'🇻🇳', yt:'T0xxOYuWKsQ' },
  { id:'ho-chi-minh',   name:'HO CHI MINH',    region:'SE ASIA',    flag:'🇻🇳', yt:'NmiZeL4GUf4' },
  { id:'jakarta',       name:'JAKARTA',        region:'SE ASIA',    flag:'🇮🇩', yt:'L_8BawGgKoM' },
  { id:'manila',        name:'MANILA',         region:'SE ASIA',    flag:'🇵🇭', yt:'ChLkwsvWjyA' },
  { id:'mumbai',        name:'MUMBAI',         region:'SOUTH ASIA', flag:'🇮🇳', yt:'8W4ZTX1z02E' },
  { id:'dubai',         name:'DUBAI',          region:'MIDDLE EAST',flag:'🌇', yt:'sa1rbpZqklc' },
  { id:'istanbul',      name:'ISTANBUL',       region:'MIDDLE EAST',flag:'🇹🇷', yt:'npTBK0VmhxI' },
  { id:'new-york',      name:'NEW YORK',       region:'AMERICAS',   flag:'🗽', yt:'XkvRMumdCxY' },
  { id:'los-angeles',   name:'LOS ANGELES',    region:'AMERICAS',   flag:'🌴', yt:'2NHIvedoKZI' },
  { id:'san-francisco', name:'SAN FRANCISCO',  region:'AMERICAS',   flag:'🌉', yt:'6yKWTDYUW-k' },
  { id:'chicago',       name:'CHICAGO',        region:'AMERICAS',   flag:'🇺🇸', yt:'5lpVhAqWFGY' },
  { id:'toronto',       name:'TORONTO',        region:'AMERICAS',   flag:'🇨🇦', yt:'nkKSq9Hulr0' },
  { id:'mexico-city',   name:'MEXICO CITY',    region:'AMERICAS',   flag:'🇲🇽', yt:'ljZW5DU00hc' },
  { id:'rio',           name:'RIO DE JANEIRO', region:'AMERICAS',   flag:'🇧🇷', yt:'wXzegSoBGFw' },
  { id:'buenos-aires',  name:'BUENOS AIRES',   region:'AMERICAS',   flag:'🇦🇷', yt:'ZzhAb_YFTt0' },
  { id:'paris',         name:'PARIS',          region:'EUROPE',     flag:'🗼', yt:'w6C3tDWkhzo' },
  { id:'london',        name:'LONDON',         region:'EUROPE',     flag:'🇬🇧', yt:'xBTwSbClbR8' },
  { id:'rome',          name:'ROME',           region:'EUROPE',     flag:'🇮🇹', yt:'seOSZlVPdgM' },
  { id:'venice',        name:'VENICE',         region:'EUROPE',     flag:'🛶', yt:'AK6dYrJpa-s' },
  { id:'barcelona',     name:'BARCELONA',      region:'EUROPE',     flag:'🇪🇸', yt:'Z8SuL0R8dGI' },
  { id:'amsterdam',     name:'AMSTERDAM',      region:'EUROPE',     flag:'🇳🇱', yt:'uL6z9v7Cf9Y' },
  { id:'prague',        name:'PRAGUE',         region:'EUROPE',     flag:'🇨🇿', yt:'FeOL2myTopk' },
  { id:'vienna',        name:'VIENNA',         region:'EUROPE',     flag:'🇦🇹', yt:'rJ2IY6rp-G8' },
  { id:'berlin',        name:'BERLIN',         region:'EUROPE',     flag:'🇩🇪', yt:'SQFtqpuA-mQ' },
  { id:'lisbon',        name:'LISBON',         region:'EUROPE',     flag:'🇵🇹', yt:'aqevs6jLdJI' },
  { id:'madrid',        name:'MADRID',         region:'EUROPE',     flag:'🇪🇸', yt:'T3KE-UVrjbI' },
  { id:'stockholm',     name:'STOCKHOLM',      region:'EUROPE',     flag:'🇸🇪', yt:'jKYN1_-aIKU' },
  { id:'copenhagen',    name:'COPENHAGEN',     region:'EUROPE',     flag:'🇩🇰', yt:'yZynH77iND4' },
  { id:'zurich',        name:'ZURICH',         region:'EUROPE',     flag:'🇨🇭', yt:'K85mHUDR0gg' },
  { id:'athens',        name:'ATHENS',         region:'EUROPE',     flag:'🇬🇷', yt:'bsDSsl11mXs' },
  ...
  { id:'lagos',         name:'LAGOS',          region:'AFRICA',     flag:'🇳🇬', yt:'kZpKPC1bk00' },
  { id:'nairobi',       name:'NAIROBI',        region:'AFRICA',     flag:'🇰🇪', yt:'iHShcn4yZN8' },
  { id:'sydney',        name:'SYDNEY',         region:'OCEANIA',    flag:'🇦🇺', yt:'HXC7bhTXNh8' },
  ...
  { id:'tokyo-window',   name:'TOKYO WINDOW',   region:'WINDOW VIEWS', flag:'🪟', yt:'CtVJo3kLAhE' },
  { id:'paris-window',   name:'PARIS WINDOW',   region:'WINDOW VIEWS', flag:'🪟', yt:'h6GFPO2A3gU' },
  { id:'ny-window',      name:'NY APARTMENT',   region:'WINDOW VIEWS', flag:'🪟', yt:'hHjGtBnSv50' },
  { id:'rainy-window',   name:'RAINY WINDOW',   region:'WINDOW VIEWS', flag:'🌧️', yt:'m2n6eFe_MpU' },
  { id:'snow-window',    name:'SNOW WINDOW',    region:'WINDOW VIEWS', flag:'❄️', yt:'1_5YOlJCdVo' },
  { id:'train-window',   name:'TRAIN WINDOW',   region:'WINDOW VIEWS', flag:'🚆', yt:'3aP1V9Yq24A' },
  { id:'night-train',    name:'NIGHT TRAIN',    region:'WINDOW VIEWS', flag:'🌙', yt:'jKq7mCOGqn8' },
  { id:'beach-window',   name:'BEACH WINDOW',   region:'WINDOW VIEWS', flag:'🌊', yt:'InqTFkh-vKo' },
  { id:'mountain-window',name:'MOUNTAIN VIEW',  region:'WINDOW VIEWS', flag:'⛰️', yt:'cFPGxaVGZYI' },
  { id:'airport-window', name:'AIRPORT LOUNGE', region:'WINDOW VIEWS', flag:'✈️', yt:'EggL9dB4GFU' },
  { id:'seoul-window',   name:'SEOUL WINDOW',   region:'WINDOW VIEWS', flag:'🪟', yt:'Af3mYkUQkpw' },
  { id:'london-window',  name:'LONDON WINDOW',  region:'WINDOW VIEWS', flag:'🪟', yt:'kB0-6bU7T-U' },
  { id:'dubai-window',   name:'DUBAI WINDOW',   region:'WINDOW VIEWS', flag:'🪟', yt:'5OFVJiOMy7I' },
  // ---- COZY SPACES (more) ----
  { id:'cabin',          name:'COZY CABIN',     region:'SPACES',       flag:'🏠', yt:'l7pGBbYAaOA' },
  { id:'bookshop',       name:'BOOKSHOP',       region:'SPACES',       flag:'📖', yt:'YcNpVMDkMlE' },
  { id:'night-balcony',  name:'NIGHT BALCONY',  region:'SPACES',       flag:'🌙', yt:'QTYKIbfT8kQ' },
  { id:'jazz-bar',       name:'JAZZ BAR',       region:'SPACES',       flag:'🎷', yt:'Dx5qFachd3A' },
  { id:'greenhouse',     name:'GREENHOUSE',     region:'SPACES',       flag:'🌿', yt:'GRTq0TakMjA' },
  ...
  { id:'aurora',         name:'AURORA',         region:'VIBES',        flag:'🌌', yt:'VoNPEW8VnYA' },
  { id:'cherry-blossom', name:'CHERRY BLOSSOM', region:'VIBES',        flag:'🌸', yt:'BhK6C4L9gvk' },
  { id:'snowfall',       name:'SNOWFALL',       region:'VIBES',        flag:'❄️', yt:'mWQjwFRMPAo' },
  { id:'starry-night',   name:'STARRY NIGHT',   region:'VIBES',        flag:'✨', yt:'xNN7iTA57jM' },
  { id:'underwater',     name:'UNDERWATER',     region:'VIBES',        flag:'🐠', yt:'NAF7mGppaU0' },
  { id:'desert-night',   name:'DESERT NIGHT',   region:'VIBES',        flag:'🌙', yt:'7nXLmFOSrxo' },
  // ---- MORE CITIES ----
  { id:'london',         name:'LONDON',         region:'EUROPE',       flag:'🇬🇧', yt:'GQ2Y-3NmvQY' },
  { id:'stockholm',      name:'STOCKHOLM',      region:'EUROPE',       flag:'🇸🇪', yt:'LKFF6rT3sEo' },
  { id:'copenhagen',     name:'COPENHAGEN',     region:'EUROPE',       flag:'🇩🇰', yt:'nJHn6yzBqTw' },
  { id:'zurich',         name:'ZURICH',         region:'EUROPE',       flag:'🇨🇭', yt:'nN1rQbLt4xM' },
  { id:'athens',         name:'ATHENS',         region:'EUROPE',       flag:'🇬🇷', yt:'MrJGXCp9lCU' },
  { id:'shanghai',       name:'SHANGHAI',       region:'EAST ASIA',    flag:'🇨🇳', yt:'_Ttu4C5OB6Y' },
  { id:'beijing',        name:'BEIJING',        region:'EAST ASIA',    flag:'🇨🇳', yt:'5WOpKNHRtek' },
  { id:'hanoi',          name:'HANOI',          region:'SE ASIA',      flag:'🇻🇳', yt:'E7b-aBaEBBY' },
  { id:'ho-chi-minh',    name:'HO CHI MINH',    region:'SE ASIA',      flag:'🇻🇳', yt:'iQ7bsNQxvys' },
  { id:'manila',         name:'MANILA',         region:'SE ASIA',      flag:'🇵🇭', yt:'lNb0y5_LAUQ' },
  { id:'jakarta',        name:'JAKARTA',        region:'SE ASIA',      flag:'🇮🇩', yt:'SN_gWLAc1dM' },
  { id:'toronto',        name:'TORONTO',        region:'AMERICAS',     flag:'🇨🇦', yt:'v6sBY1KCNSQ' },
  { id:'buenos-aires',   name:'BUENOS AIRES',   region:'AMERICAS',     flag:'🇦🇷', yt:'wGnpYH4GEBY' },
  { id:'lagos',          name:'LAGOS',          region:'AFRICA',       flag:'🇳🇬', yt:'bGy5VL0H_hI' },
  { id:'nairobi',        name:'NAIROBI',        region:'AFRICA',       flag:'🇰🇪', yt:'VPxfHuMmkdg' },
];
